...
import { acceptConnection, discoverUser, followUser, getAllConnections, getUserData, getUserProfile, sendConnection, unfollowUser, updateUserData } from '../controllers/user.controller.js';
