...
import { acceptConnection, discoverUser, followUser, getAllConnections, getUserData, sendConnection, unfollowUser, updateUserData } from '../controllers/user.controller.js';
